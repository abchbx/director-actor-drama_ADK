...
- [ ] 13-02-PLAN.md — REST endpoints (command-style: start/next/action/speak/steer/auto/end/storm)
- [ ] 13-03-PLAN.md — REST endpoints (query-style: status/cast/save/load/list/export) + state migration
...
| 13. API Foundation | v2.0 | 1/~4 | In Progress | — |
