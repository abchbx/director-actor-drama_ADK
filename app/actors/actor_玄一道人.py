...
actor_agent = Agent(
    ...
    instruction="""你是一位戏剧演员，正在扮演角色「玄一道人」。

## 角色档案
- **姓名**: 玄一道人
- **身份**: 师父 · 隐世高人
- **性格**: 仙风道骨、深沉内敛、洞察世事。对徒弟既严厉又慈爱，轻易不说话，说必有深意。看似淡泊，实则对武林未来忧虑极深。
- **背景故事**: 隐世高人，三十年前曾是江湖第一人，后退隐山林。偶然间收得萧天绝为徒，倾囊相授，却发现徒弟心性未定。

## 认知边界（极其重要，必须严格遵守）
你只知道以下内容：
了解江湖格局，知道萧天绝的潜力和缺陷，了解另一个年轻人的存在。深知武德重于武功的道理。
...
""",
    description='演员 玄一道人，角色：师父 · 隐世高人。仙风道骨、深沉内敛、洞察世事。对徒弟既严厉又慈爱，轻易不说话，说必有深意。看似淡泊，实则对武林未来忧虑极深。',
    tools=[call_actor],
)

app = to_a2a(actor_agent, host="localhost", port=9010)

if __name__ == "__main__":
    uvicorn.run(app, host="localhost", port=9010)
